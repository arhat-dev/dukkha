...
var static_symbols = [tu.FuncID_LAST_Static_FUNC + 1]tengo.Symbol{
	...
	tu.FuncID_archconv_HardFloatArch:      {Name: "archconv.HardFloatArch", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_archconv_HardFloatArch)},
	...
	tu.FuncID_re_FindFirst:                {Name: "re.FindFirst", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_re_FindFirst)},
	tu.FuncID_re_FindN:                    {Name: "re.FindN", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_re_FindN)},
	...
	tu.FuncID_re_ReplaceAll:               {Name: "re.ReplaceAll", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_re_ReplaceAll)},
	tu.FuncID_re_ReplaceAllNoExpand:       {Name: "re.ReplaceAllNoExpand", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_re_ReplaceAllNoExpand)},
	tu.FuncID_re_ReplaceFirst:             {Name: "re.ReplaceFirst", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_re_ReplaceFirst)},
	tu.FuncID_re_ReplaceFirstNoExpand:     {Name: "re.ReplaceFirstNoExpand", Scope: tengo.ScopeGlobal, Index: int(tu.FuncID_re_ReplaceFirstNoExpand)},
