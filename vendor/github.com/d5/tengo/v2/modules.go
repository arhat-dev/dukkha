...
type ModuleGetter[Self any] interface {
	New() Self
	IsNil() bool
...
var _ ModuleGetter[*ModuleMap] = (*ModuleMap)(nil)
...
// IsNil implements ModuleGetter
func (m *ModuleMap) IsNil() bool {
	return m == nil
}

// New implements ModuleGetter
func (*ModuleMap) New() *ModuleMap {
	return NewModuleMap()
}
