...
var (
	...
	builtinFunctionSymbols = [...]Symbol{
		{Name: "len", Scope: ScopeBuiltin, Index: 0},
		{Name: "copy", Scope: ScopeBuiltin, Index: 1},
		{Name: "append", Scope: ScopeBuiltin, Index: 2},
		{Name: "delete", Scope: ScopeBuiltin, Index: 3},
		{Name: "splice", Scope: ScopeBuiltin, Index: 4},
		{Name: "string", Scope: ScopeBuiltin, Index: 5},
		{Name: "int", Scope: ScopeBuiltin, Index: 6},
		{Name: "bool", Scope: ScopeBuiltin, Index: 7},
		{Name: "float", Scope: ScopeBuiltin, Index: 8},
		{Name: "char", Scope: ScopeBuiltin, Index: 9},
		{Name: "bytes", Scope: ScopeBuiltin, Index: 10},
		{Name: "time", Scope: ScopeBuiltin, Index: 11},
		{Name: "is_int", Scope: ScopeBuiltin, Index: 12},
		{Name: "is_float", Scope: ScopeBuiltin, Index: 13},
		{Name: "is_string", Scope: ScopeBuiltin, Index: 14},
		{Name: "is_bool", Scope: ScopeBuiltin, Index: 15},
		{Name: "is_char", Scope: ScopeBuiltin, Index: 16},
		{Name: "is_bytes", Scope: ScopeBuiltin, Index: 17},
		{Name: "is_array", Scope: ScopeBuiltin, Index: 18},
		{Name: "is_immutable_array", Scope: ScopeBuiltin, Index: 19},
		{Name: "is_map", Scope: ScopeBuiltin, Index: 20},
		{Name: "is_immutable_map", Scope: ScopeBuiltin, Index: 21},
		{Name: "is_iterable", Scope: ScopeBuiltin, Index: 22},
		{Name: "is_time", Scope: ScopeBuiltin, Index: 23},
		{Name: "is_error", Scope: ScopeBuiltin, Index: 24},
		{Name: "is_undefined", Scope: ScopeBuiltin, Index: 25},
		{Name: "is_function", Scope: ScopeBuiltin, Index: 26},
		{Name: "is_callable", Scope: ScopeBuiltin, Index: 27},
		{Name: "type_name", Scope: ScopeBuiltin, Index: 28},
		{Name: "format", Scope: ScopeBuiltin, Index: 29},
		{Name: "range", Scope: ScopeBuiltin, Index: 30},
	}
)
...
func GetAllBuiltinFunctionSymbols() []Symbol {
	return builtinFunctionSymbols[:]
}
